...
public enum ModArmorMaterials implements ArmorMaterial {
    FORTIFIED_STONE("gsmod:fortified_stone", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_NETHERITE, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.FORTIFIED_STONE.get());
    });
